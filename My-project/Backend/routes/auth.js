...
const jwt = require('jsonwebtoken')
 ...
 const {registerValidation,loginValidtaion,validation} = require('../middleware/RegisterValidator')

const {isAuth} = require('../middleware/isAuth')
//http://localhost:5000/auth/register    => register tdkhlin infoi mte3 el user 
